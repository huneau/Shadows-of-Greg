...
public class TileEntityThermalCentrifuge extends RecipeMapMultiblockController {
    ...
    public TileEntityThermalCentrifuge(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeMaps.THERMAL_CENTRIFUGE_RECIPES);
        this.recipeMapWorkable = new TileEntityThermalCentrifuge.MultiThermalCentrifuge(this);
    ...
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new TileEntityThermalCentrifuge(metaTileEntityId);
    }


    protected class MultiThermalCentrifuge extends MultiblockRecipeLogic {

        public MultiThermalCentrifuge(RecipeMapMultiblockController tileEntity) {
            super(tileEntity);
        }
