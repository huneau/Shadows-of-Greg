...
public class TileEntityLargeWashingPlant extends LargeSimpleRecipeMapMultiblockController {
	...
	public IBlockState getCasingState() {
		return GAMetaBlocks.METAL_CASING.getState(GAMetalCasing.MetalCasingType.GRISIUM);
	}

	@Override
	public ICubeRenderer getBaseTexture(IMultiblockPart sourcePart) {
		return ClientHandler.GRISIUM;
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
		tooltip.add(I18n.format("gregtech.multiblock.large_washin_plant.description"));
	}
