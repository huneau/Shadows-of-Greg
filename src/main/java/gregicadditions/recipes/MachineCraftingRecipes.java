...
public class MachineCraftingRecipes {
	...
	public static void init() {
		...
		ModHandler.addShapedRecipe("ga_large_thermal_centrifuge", GATileEntities.LARGE_THERMAL_CENTRIFUGE.getStackForm(), "CBC", "RHR", "CDC", 'H', THERMAL_CENTRIFUGE[4].getStackForm(), 'R', new UnificationEntry(OrePrefix.stick, Materials.RedSteel), 'B', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'C', new UnificationEntry(OrePrefix.plate, Materials.RedSteel), 'D', new UnificationEntry(OrePrefix.gear, Materials.RedSteel));
		ModHandler.addShapedRecipe("ga_large_electrolyzer", GATileEntities.LARGE_ELECTROLYZER.getStackForm(), "CBC", "RHR", "CDC", 'H', THERMAL_CENTRIFUGE[4].getStackForm(), 'R', new UnificationEntry(OrePrefix.stick, Materials.RedSteel), 'B', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'C', new UnificationEntry(OrePrefix.plate, Materials.RedSteel), 'D', new UnificationEntry(OrePrefix.gear, Materials.RedSteel));
		ModHandler.addShapedRecipe("ga_large_bender_and_forming", GATileEntities.LARGE_BENDER_AND_FORMING.getStackForm(), "CBC", "RHR", "CDC", 'H', THERMAL_CENTRIFUGE[4].getStackForm(), 'R', new UnificationEntry(OrePrefix.stick, Materials.RedSteel), 'B', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Extreme), 'C', new UnificationEntry(OrePrefix.plate, Materials.RedSteel), 'D', new UnificationEntry(OrePrefix.gear, Materials.RedSteel));
